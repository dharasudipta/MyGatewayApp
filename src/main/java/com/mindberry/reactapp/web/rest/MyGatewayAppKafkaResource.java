...
@RestController
@RequestMapping("/api/my-gateway-app-kafka")
public class MyGatewayAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyGatewayAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MyGatewayAppKafkaResource(KafkaProperties kafkaProperties) {
